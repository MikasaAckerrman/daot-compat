...
## Как загрузить через веб
1. Зайди в эту папку на github.com
2. `Add file` → `Upload files`
3. Перетащи JAR'ы → `Commit changes`

⚠️ Лимит web-аплоада: 25 MB на файл. Если больше — используй GitHub Desktop или git CLI.
